...
sidebarTitle: "运算方法和运算部件"
description: "整理定点数加减乘除、Booth 乘法、除法修正与浮点数舍入。"
tags: ["考研408", "计算机组成原理"]
---

本章整理定点数的加减乘除、标志位判断、Booth 乘法，以及浮点数舍入规则。建议按“加减法 → 乘法 → 除法 → 浮点舍入”的顺序复习。
...
<AccordionGroup>
  ...
  <Accordion title="无符号数和补码加减法">
    ![补码加减法运算示意](/images/computer-architecture/Chapter3_Compound_1.webp)
...
<AccordionGroup>
  <Accordion title="原码乘法运算">
    ...
    ![原码一位乘法步骤 1](/images/computer-architecture/Chapter3_Usigned_1.webp)
    ![原码一位乘法步骤 2](/images/computer-architecture/Chapter3_Usigned_2.webp)
  </Accordion>

  <Accordion title="补码乘法运算与 Booth 乘法">
    ![补码乘法步骤 1](/images/computer-architecture/Chapter3_TwoC_1.webp)
    ![补码乘法步骤 2](/images/computer-architecture/Chapter3_TwoC_2.webp)
    ...
    A. D. Booth 提出了一种**补码相乘算法**：符号位与数值位合在一起参与运算，正数与负数同等对待，直接得到补码形式的乘积。下面以 $n$ 位补码定点整数说明其推导思路
...
<AccordionGroup>
  <Accordion title="原码除法运算">
    ...
    ![原码除法流程](/images/computer-architecture/Chapter3_Div.webp)

    ### 恢复余数除法

    ![恢复余数除法步骤 1](/images/computer-architecture/Chapter3_Div_Reset_1.webp)
    ![恢复余数除法步骤 2](/images/computer-architecture/Chapter3_Div_Reset_2.webp)

    ### 不恢复余数除法

    ![不恢复余数除法步骤 1](/images/computer-architecture/Chapter3_Div_Noreset_1.webp)
    ![不恢复余数除法步骤 2](/images/computer-architecture/Chapter3_Div_Noreset_2.webp)
  </Accordion>
  ...
  <Accordion title="补码除法运算">
    ...
    ![补码除法规则](/images/computer-architecture/Chapter3_TwoC_Div_Rules.webp)
    ...
    ![补码恢复余数除法](/images/computer-architecture/Chapter3_TwoC_Div_Reset.webp)
    ...
    ![补码不恢复余数除法](/images/computer-architecture/Chapter3_TwoC_Div_Noreset.webp)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="舍入方式">
    ...
    ![浮点数舍入结果示例](/images/computer-architecture/Chapter3_Result_Rounding.webp)
  </Accordion>
</AccordionGroup>
